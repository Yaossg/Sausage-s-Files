...
要解答这些问题，就要从旧版的世界生成说起，囿于主题、篇幅，也囿于我的能力，实在不想，也不能把1.12以前的地形生成解析一遍，在文末的相关链接我给出了土球的一个简要解析，从中我们似乎看不出太大的问题，新版似乎和旧版一样，世界生成在按部就班地进行。

这次代码重构Mojang采用了全新的设计模式，增加了代码的可扩展性，主要体现在：
...
- [Forge 1.12.2](https://files.minecraftforge.net/)
